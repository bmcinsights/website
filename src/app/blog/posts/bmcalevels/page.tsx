    ...
    <div className="min-h-screen bg-black text-white flex my-8 justify-center p-4 pt-8">
      <div className="max-w-3xl w-full">
        ...
        <div className="text-gray-400 text-lg mb-4">
          <span>by </span>
          <span className="text-gray-300 font-semibold">Manish Pandeya</span>
        </div>
        ...
        <p className="text-gray-300 text-xl leading-relaxed mt-4">
          <span className="font-semibold">What Actually ARE A-Levels?</span>
          <br /> Let's cut through the confusion. A-Levels (or Cambridge
          International A-Levels, if we're being fancy) is basically the British
          equivalent of +2, but with some major perks. Here's what makes it
          different:
        </p>
        ...
        <p className="text-gray-300 text-xl leading-relaxed mt-4">
          ...
          between)
          <br />
          - Small classes (my largest class has 25 students)
          <br />
          - Lots of practical work and experiments in our labs
          <br />
        ...
        <p className="text-gray-300 text-xl leading-relaxed mt-4">
          ...
          has your back:
          <br />
          - We have a two-week orientation program that really helps
          <br />
          - Senior buddies who guide you through everything
          <br />
        ...
        <p className="text-gray-300 text-xl leading-relaxed mt-4">
          ...
          <br />
          - Amazing labs (our physics lab is my favorite spot)
          <br />
        ...
        <p className="text-gray-300 text-xl leading-relaxed mt-4">
          <span className="font-semibold">The Real Investment</span>
          <br />
          Let's talk money (because it matters):
          <br />
          - Fees are higher than +2, but there are scholarships that can cover
          up-to 100% of tuition for high achieving students
          <br />
        ...
        <p className="text-gray-300 text-xl leading-relaxed mt-4">
          ...
          <br />
          - The freedom to study what I actually enjoy
          <br />
          - Opportunities like The BMC Insights to develop real skills
          <br />
        ...
        <p className="text-gray-300 text-xl leading-relaxed mt-4">
          <span className="font-semibold">Want to See for Yourself?</span>
          <br />
          Come check us out:
          <br />
          - Visit during our open house days
          <br />
        ...
        <p className="text-gray-300 text-xl leading-relaxed mt-4">
          <span className="font-semibold">P.S. -</span> If you're worried about
          the switch from SEE to A-Levels, trust me - if I could do it, so can
          you! :)
        </p>

        <p className="text-gray-300 text-xl leading-relaxed mt-4">
          Your future could be at BMC. Why not come see for yourself?
          <br />
          Contact us for a campus visit or check out our upcoming open house
          dates. Your A-Level journey could start right here!
        </p>
      </div>
    </div>
  );
