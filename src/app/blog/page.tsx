          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="md:w-2/3">
              <a href="/blog/posts/bmcalevels">
                <h2 className="text-2xl hover:text-primary sm:text-3xl font-bold mb-4 text-text">
              ...
              <p className="text-lg sm:text-xl">
                ...
                safer!" "A-Levels will open more doors!" "But what about Nepali
                subject?" Trust me, I know exactly how overwhelming it feels.
                I'm Manish, currently in my second year at British Model College
                (BMC), and two years ago, I was just as confused as you probably
                are right now. But since you're here, let me share the real
                scoop about A-Levels at BMC - everything I wish someone had told
