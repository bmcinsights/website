            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="space-y-12">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-xl text-text text-opacity-60 max-w-3xl mx-auto">
                            Fostering intellectual discourse and creative expression at British Model College
                        </p>
                    </div>

                    {/* About Section */}
                    <div className="bg-secondary bg-opacity-30 rounded-lg p-8 shadow-2xl">
                        <h2 className="text-3xl font-semibold text-text mb-6">
                            About Us
                        </h2>
                        <p className="text-text text-opacity-60 leading-relaxed mb-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="bg-secondary bg-opacity-30 rounded-lg p-8 shadow-2xl">
                            ...
                            <ul className="space-y-4 text-text text-opacity-60">
                    ...
                    {/* Contact Section */}
                    <div className="text-center bg-secondary bg-opacity-30 rounded-lg p-8 shadow-2xl">
                        <h3 className="text-2xl font-semibold text-text mb-4">
                            Get Involved
                        </h3>
                        <p className="text-text text-opacity-60 mb-6">
                            Interested in becoming a part of The BMC Insights? We're always looking for passionate writers, editors, and creative minds!
                        </p>
                        <a href="https://docs.google.com/forms/d/e/1FAIpQLSfXTUhse5GuFSAQgOyEL6VeKFh8NUtRVx7XcnSSgxJgdW7hyw/viewform?usp=dialog" target="_blank">
                        <button className="bg-primary hover:bg-opacity-60 text-white px-8 py-3 rounded-full transition duration-300 transform hover:scale-105">
                            Join Now
                        </button>
                        </a>
                    </div>
